...
class TwoHemiRNNTanh_single_readout(nn.Module):
    ...
    def init_params(self):
        ...
        if self.symmetric_weights:
            ...
            self.w_xh_linear_right_alm.weight.data = torch.tensor([[0.1, 0.0],[0.0,0.1]], dtype=torch.float32)
            self.w_xh_linear_left_alm.weight.data = torch.tensor([[0.1, 0.0],[0.0,0.1]], dtype=torch.float32)
